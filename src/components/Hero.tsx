...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <a 
        href="#about" 
        className={`absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-muted-foreground hover:text-foreground transition-colors ${animationComplete ? '' : 'hidden'}`}
      >
